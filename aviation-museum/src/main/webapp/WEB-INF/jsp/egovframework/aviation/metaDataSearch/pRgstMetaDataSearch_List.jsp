          ...
          <div class="card-body">
            <div class="table-responsive">
               ...
               <form id="metaDataDetailSearchListForm" name="metaDataDetailSearchListForm" method="post" class="form-horizontal">            	
                  ...
                  <button type="button" onClick="metaDataDetailSearchList();" id="search">검색</button>
              	</form>      
            </div>
          </div>
        </div>
	...
	<!--                 </div> -->
              ...
              <div class="search_btn_wrap" style="width: 1200px;">
                <div class="search_btn_left">
                 <button class="custom_btn btn_c57283" data-bs-toggle="modal" data-bs-target="#LikeModal">관심자료등록</button >
<!--                  <button class="custom_btn btn_c28876">항목 추가 및 삭제</button> -->
                </div>
                <div class="search_btn_right">
                <button class="custom_btn btn_707070" style="display:none;">사용자 지정양식 인쇄</button>
                <button class="custom_btn btn_707070" onclick="content_print()">목록 인쇄</button>
                <button class="custom_btn btn_ex"  type="button" onClick="metaDataSearchListExcelList();">엑셀파일</button></div>
              </div>
              <!-- 관심자료 모달창 -->
		                        ...
		                        <tr onclick="quickView('${metaDataSearchList.item_idx}');">
		                          ...
		                          <td>
		                            <div class="search_img_wrap">
		                             	<c:choose>
		                             		<c:when test="${metaDataSearchList.image_nm ne null}">
		                             		 	 <img src="<c:url value='/images/${metaDataSearchList.image_nm }'/>" alt="이미지" onerror="this.onerror=null; this.src='/assets/images/no_image.png';"/>
		                            		</c:when>
		                            		<c:otherwise>
		                          ...
		                          <td><a  onclick="metaDataListView('${metaDataSearchList.possession_code_idx}','${metaDataSearchList.org_code_idx}','${metaDataSearchList.item_no}','${metaDataSearchList.item_detail_no}','N')">${metaDataSearchList.item_nm}</a></td>
