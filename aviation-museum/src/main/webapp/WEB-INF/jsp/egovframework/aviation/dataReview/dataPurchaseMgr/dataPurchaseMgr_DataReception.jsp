<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
            ...
            <div class="tab-pane" id="datareview_4" role="tabpanel" style="display:block;">
              <!--  -->
              <div id="data_buy_management_modal_2" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      <div class="modal-header mv-modal-header">
                        ...
                        <div class="modal-body mv-modal-body">
                                        ...
                                        <td>
                                          ...
                                          <td>
                                            <select class="form-select st_select img-select">
                                              <option disabled="" selected="">실물접수 완료</option>
                                              <option>접수 완료</option>
                                              <option>미접수</option>
                                            </select>
                                          </td>
                          ...
                          <!-- -->
                          <div class="st_wrap">
                            <label class="col-md-2 col-form-label st_title">실무검토</label>
                          </div>
                          <div class="mb-0 user-wrap">
                            <!---->
                            <div class="document_review_wrap">
                              <div class="document_review_comment_wrap">
                                <div class="drc_profile_img"><img src="" alt=""></div>
                                <div class="drc_date_info">
                                  <p>2023.03.01/12:30:30</p>
                                  <p>심사의원1 (소장풍)</p>
                                </div>
                                <div class="drc_check drc_check_1">적정</div>
                                <div class="drc_comment">보관 상태가 훌륭합니다. 구매하고 싶습니다.</div>
                              </div>
                            </div>
                            <!--  -->
                            <div class="document_review_wrap">
                              <div class="document_review_comment_wrap">
                                ...
                                <div class="drc_check drc_check_2">부적정</div>
                                <div class="drc_comment">보관 상태가 훌륭합니다. 구매하고 싶습니다.</div>
                              </div>
                            </div>
                          </div>
                          <!-- -->
                          <div class="st_wrap">
                            <label class="col-md-2 col-form-label st_title">종합의견</label>
                          </div>
                          <div class="mb-0 user-wrap">
                            이미 소장중인 자료로 판단도지ㅣ만 상태가 더 좋아 구매합니다.
                          </div>
                          <!--  -->
                          <div class="st_wrap">
                            <label class="col-md-2 col-form-label st_title">자료 감정가(심사위원 의견)</label>
                          </div>
                          <div class="mb-0 user-wrap">
                            <div class="table-responsive">
                              <table class="table mb-0">
                          ...
                          <!--  -->
                          <div class="st_wrap">
                            <label class="col-md-2 col-form-label st_title">구입감정서</label>
                          </div>
                          <div class="mb-0 user-wrap">
                            <table class="table mb-0">
                              <thead>
              ...
              <div class="st_wrap st_mv_wrap">
                <p style="width: 50%;">| 심의 현황 : 접수자 1,000건, 총 건수 1,000건
                  <button class="custom_btn btn_000000" type="button">전체선택</button>
                  <button class="custom_btn btn_b95d40" type="button">선택해제</button>
                  <button class="custom_btn btn_707070" type="button">선택 구입감정요청</button>
                  <button class="custom_btn btn_707070" type="button">전체 구입감정요청</button>
                </p>
                <div>
                  리스트 출력 갯수 :
                    ...
                    <table class="table mb-0">
                      ...
                      <tbody>
                          <tr>
                            ...
                            <td>10,000원</td>
                            <td>심의중</td>
                            <td><button class="custom_btn btn_232323" type="button" data-bs-toggle="modal" data-bs-target="#data_buy_management_modal_2">상세보기</button></td>
                            <td><button class="custom_btn btn_edit" type="button">요청</button></td>
                          </tr>
                      </tbody>
                  </table>
                  </div>
