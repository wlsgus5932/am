                          ...
                          <div class="mb-0 user-wrap">
                            ...
                            <table class="table mb-0">
                              <tbody>
                                  <tr>
                                    <td>감정금액</td>
                                    <td><input type="text" name="" id="" placeholder="금액을 숫자로 작성해 주세요."></td>
                                    <td rowspan="2"><button>등록</button></td>
                                  </tr>
                                  <tr>
                                    <td>의견</td>
                                    <td><input type="text" name="" id="" placeholder="의견을 작성해 주세요."></td>
                                  </tr>
                              </tbody>
                          </table>
                          </div>
                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                  <tr>
                                    ...
                                    <td>5</td>
                                    <td>3,000,000원</td>
                                    <td><input type="text" name="" id="" placeholder="금액을 숫자로 입력해 주세요."></td>
                                    <td><input type="text" name="" id="" placeholder="기타 의견을 등록해 주세요."></td>
                                  </tr>
                              </tbody>
                          </table>
                          </div>
