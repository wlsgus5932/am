<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
                ...
                <!-- 구입심의 탭 시작 -->
            <div class="tab-pane" id="datareview_6" role="tabpanel" style="display:block;">
              <!-- 구입심의, 매도대상자료 상세보기 모달-->
              <div id="data_buy_management_modal_4" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
