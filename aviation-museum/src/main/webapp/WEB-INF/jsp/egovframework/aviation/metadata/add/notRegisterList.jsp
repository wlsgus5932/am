    ...
    <jsp:include page="../../common/inc/headerContent.jsp" />
      ...
      <!-- modalzone 모달 -->
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
						  ...
						  <input type="hidden" id="deletion_page" name="page" value="1"/>
					        ...
					        <!--  -->
					        <div><button class="custom_btn btn_707070" type="button" onclick="checkDelete()">삭제신청</button><button class="custom_btn btn_707070" type="button">닫기</button></div>
					      </div>
					    </div>
					  </div>
					</div>
       ...
       <form class="main_1550px" id="add-form">
        ...
        <div class="tap_text">
            <h2>가등록 자료 정보 조회</h2>
            <p>자료 등록 > <span> 가등록 자료 정보 조회 </span></p>
          </div>
          <!-- 자료구분 셀렉트 -->
          <div class="fr_wrap">
                            ...
                            <td>
                              ...
                              <td>
                                ...
                                <c:forEach var="list" items="${exchangeList}" varStatus="status">
                                	<button class="custom_btn btn_707070" onclick="window.open('${list.service_url}')">환율정보</button>
                                </c:forEach>
                              </td>
                              <td>
