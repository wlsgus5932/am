            ...
            <div class="simple_view_footer">
              <c:choose>
	              <c:when test="${image eq null }">
	              	<span><a href="javascript:quickView('${metaDataSearchQuickView.prev}');">< 이전자료</a></span> | <span><a href="javascript:quickView('${metaDataSearchQuickView.next}');">다음자료 ></a></span> | <span><a href="">자세히보기</a></span>
	          	  </c:when>
	          	  <c:otherwise>
	          	  	<span><a href="javascript:imageQuickView('${metaDataSearchQuickView.prev}');">< 이전자료</a></span> | <span><a href="javascript:imageQuickView('${metaDataSearchQuickView.next}');">다음자료 ></a></span> | <span><a href="">자세히보기</a></span>
	          	  </c:otherwise>
          	  </c:choose>
            </div>
         </c:forEach>