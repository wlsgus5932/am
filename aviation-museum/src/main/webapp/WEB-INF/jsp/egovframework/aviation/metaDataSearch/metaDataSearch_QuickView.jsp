	...
	<div class="simple_view_wrap2">
        ...
        <c:forEach var="metaDataSearchQuickView" items="${metaDataSearchQuickView}">
            ...
            <div class="simple_view_thumb">
              <c:choose>
	            		<c:when test="${metaDataSearchQuickView.thumbnail_nm ne null}">
	            		 	 <img src="<c:url value='${metaDataSearchQuickView.image_path}thumbnails/${metaDataSearchQuickView.thumbnail_nm}'/>" alt="이미지" onerror="this.onerror=null; this.src='/assets/images/no_image.png';"/>
	           		</c:when>
	           		<c:otherwise>
