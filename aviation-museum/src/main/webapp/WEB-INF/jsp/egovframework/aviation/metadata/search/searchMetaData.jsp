          ...
          <div class="accordion quick_menu" id="accordionExample">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body accordion-body_2">
                  <div class="text-muted">
                    <strong class="text-dark">
                      <ul>
                        <li><a href="#">연표</a></li>
                      ...
                      <div class="card-body">
                        <div class="slider_count_wrap">
                          ...
                          <div class="card-title-desc">
                            <button class="custom_btn btn_707070" type="button">원본보기</button>
                            <button class="custom_btn btn_707070" type="button">다운로드</button>
                          </div>
                          <!--  -->
	                            ...
	                            <tbody id="class-tbody">
	                                <tr id="class-tr">
	                                 <!--  <input type="checkbox" name="class-checkbox" id=""> -->
	                                    <td scope="row" id="row-number">1</td>
	                                    <td>
	                                      선택
	                                    </td>
	                                    <td>
