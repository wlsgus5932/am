...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>실무검토 심의-자료심의 | 국립항공박물관</title>
    ...
    $(function() {
		...
		// 첫 페이지
		$('#practicalReview').attr('aria-selected', 'true').addClass('active');
		
		$.ajax({
			type : 'POST',                
			url : '/practicalReviewList.do',    
			dataType : "html",           
		...
		$('#practicalReview').click(function() {
			$.ajax({
				type : 'POST',                
				url : '/practicalReviewList.do',    
				dataType : "html",           
        ...
        <div class="page-content">
          ...
          <div class="wr_header_wrap">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="tab" href="#datareview_1" role="tab" id="practicalReview">
                      <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                      <span class="d-none d-sm-block">실무검토 심의</span>
                  </a>
              </li>
            </ul>
                ...
                <div class="modal-content">
                  <div class="modal-header mv-modal-header">
                    ...
                    <div class="modal-body mv-modal-body">
                      <div class="st_wrap">
                        <label class="col-md-2 col-form-label st_title">자료구입실무검토서</label>
                      </div>
                      <!--  -->
                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                <tr>
                                  <td>비행지도 외 336건</td>
                                  <td>
                                    적정 (221건 2,684점)<button onclick="window.open('자료구입검토서-적정리스트-레이어팝업.html')">상세보기</button>
                                    <br>
                                    부적정 (11건 402점)<button onclick="window.open('자료구입검토서-부적정리스트-레이어팝업.html')">상세보기</button>
                                  </td>
