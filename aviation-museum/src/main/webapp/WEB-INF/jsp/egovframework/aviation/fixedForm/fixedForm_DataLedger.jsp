              ...
              <div class="mb-3 row fr_1">
                  ...
                  <div class="col-md-10">
                      ...
                      <!-- <div class="col-md-10"> -->
                        ...
                        <button class="custom_btn btn_search" type="button" onClick="dataLedgerSearchList();">검색</button>
                  </div>
                 </form>
              </div>
            </div>
                  ...
                  <div class="col-md-10">
                    ...
                    <input class="custom_search_input" type="text" placeholder="10" readonly="readonly" value="${dataLedgerListTotal}" id="page_total_num2">
                      ...
                      <!-- <div class="col-md-10"> -->
                        ...
                        <button class="custom_btn btn_search" onclick="ledger_print()">인쇄</button>
                  </div>
                </div>
              </div>
