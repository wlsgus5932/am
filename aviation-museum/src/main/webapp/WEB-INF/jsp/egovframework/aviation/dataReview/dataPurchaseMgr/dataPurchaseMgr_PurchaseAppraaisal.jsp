<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
            ...
            <div class="tab-pane" id="datareview_5" role="tabpanel" style="display:block;">
              <!-- 구입감정, 매도대상자료명세서 상세보기 모달 -->
            <div id="data_buy_management_modal_3" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
              ...
              <div class="st_wrap st_mv_wrap">
                ...
                <div style="width: 22%;">
                  <button class="custom_btn btn_707070" type="button">구입감정서 보기</button>
                  리스트 출력 갯수 :
                  ...
                  <table class="table mb-0">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td>10,000원</td>
                          <td>심의중</td>
                          <td><button class="custom_btn btn_232323" type="button" data-bs-toggle="modal" data-bs-target="#data_buy_management_modal_3">상세보기</button></td>
                        </tr>
                    </tbody>
                </table>
              </div>
