                ...
                <div class="fr_wrap">
                  <div class="mb-3 row fr_1">
                    <div class="col-md-10">
                      ...
                      <input class="custom_search_input" type="text" placeholder="자료번호">
                      <input class="custom_search_input" type="text" placeholder="세부번호">
                    </div>
                    <div class="col-md-10">
                      ...
                      <table class="table mb-0">
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td>-</td>
                                <td>-</td>
                                <td><button class="custom_btn btn_edit" data-bs-toggle="modal" data-bs-target="#view_Modal" type="button">보기</button></td>
                              </tr>
                          </tbody>
                      </table>
                  </div>
