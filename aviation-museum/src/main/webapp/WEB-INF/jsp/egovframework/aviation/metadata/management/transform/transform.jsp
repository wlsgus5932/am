              ...
              <div class="col-md-10">
                <label class="col-md-2 col-form-label">자료 구분</label>
                 ...
                 <select class="search_select" id="org_code_idx" name="org_code_idx">
                  ...
                  <!-- <div class="col-md-10"> -->
                    <input class="custom_search_input" list="datalistOptions" id="item_no1" name="item_no1" placeholder="자료 번호" type="number">
                    <input class="custom_search_input" list="datalistOptions" id="item_detail_no1" name="item_detail_no1" placeholder="세부 번호" type="number">
                    ~
                    <input class="custom_search_input" list="datalistOptions" id="item_no2" name="item_no2" placeholder="자료 번호" type="number">
                    <input class="custom_search_input" list="datalistOptions" id="item_detail_no2" name="item_detail_no2" placeholder="세부 번호" type="number">
