                    ...
                    <div class="modal-content">
                      <div class="modal-header mv-modal-header">
                        ...
                        <div class="modal-body mv-modal-body">
                          ...
                          <!-- 서류심사 -->
                          <div class="st_wrap">
                            <label class="col-md-2 col-form-label st_title">서류심사</label>
                          </div>
                          <div class="mb-0 user-wrap">
                            <!-- 서류심사한줄 -->
                            ...
                            <!--  -->
                            <!-- 적정 부적정 체크 -->
                            <div class="data_riveiw_check_wrap">
                              <input type="checkbox" name="" id="">적정
                              <input type="checkbox" name="" id="">부적정
                              <input type="text" name="" id="" placeholder="의견을 작성해 주세요.">
                              <button>등록</button>
                            </div>
                          </div>
                          <!-- 서류심사 의견종합 -->
                          ...
                          <div class="mb-0 user-wrap">
                            <input style="width: 100%; height: 200px;"  type="text" placeholder="의견을 작성해 주세요.">
                          </div>
