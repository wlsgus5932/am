...
public class FixedFormVO {
	...
	public String toString() {
		return "FixedFormVO [rnum=" + rnum + ", item_idx=" + item_idx + ", feature=" + feature + ", material1_nm="
				+ material1_nm + ", material2_nm=" + material2_nm + ", material_detail=" + material_detail
				+ ", detail_year=" + detail_year + ", era_nm=" + era_nm + ", country_nm=" + country_nm
